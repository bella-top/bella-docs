...
export default function BellaAssistantsApiPage() {
  ...
  const specUrl = useBaseUrl(
    currentLocale === 'en' 
      ? '/openapi/bella-assistants/' + 'openapi-en.json' 
      : '/openapi/bella-assistants/' + 'openapi.json' 
  );
